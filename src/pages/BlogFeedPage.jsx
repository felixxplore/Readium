              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="px-4 py-2 font-medium text-white bg-gray-950 rounded-lg hover:bg-gray-800 transition-colors"
                  >
                    Sign up
                  </button>
                </>
                  ...
                  {isAuthenticated ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 font-medium text-white bg-gray-950 rounded-lg hover:bg-gray-800 transition-colors"
                      >
                        Sign up
                      </button>
                    </>
...
function FeaturedPostHero({ post, onClick }) {
  return (
    <div className="relative bg-gradient-to-r from-gray-950 to-gray-900 overflow-hidden">
